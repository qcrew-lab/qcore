...
class Connection(h5py.File):
    """
    A class inherits from h5py.File that allows us to set the default 
    driver or other parameters for h5py.File 
    """
    def __init__(self, name, 
                 mode=None, 
                ):
        super(Connection, self).__init__(name=name, 
                                         mode=mode)

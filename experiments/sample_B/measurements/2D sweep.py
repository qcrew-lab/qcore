...
##Read csv
if 1:
    filepath_with = Path.cwd() / "data/sample_B/2021-06-09/15-35-11_rr_spec_sweep_amp-Copy-withqubit.csv"
...
colormap = axis.pcolormesh(freqs, pows[:], signal_diff[:], 
cmap="terrain",

""" Qubit spectroscopy measurement script v3.0 """
...
meas_name = "qubit_spec"  # used as the suffix for the saved data file/plot
...
job = stg.qm.execute(qubit_spec)  # run measurement
